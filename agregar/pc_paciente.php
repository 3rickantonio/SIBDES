    ...
    <title>Prueba Celular Paciente</title>
        ...
        <div class="container" style="margin-top:50px;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-3 col-lg-offset-3 toppad">
                    ...
                    <form accept-charset="UTF-8" role="form" method="POST" action="pc_paciente.php">
                        <div class="panel panel-info">
                            <div class="panel-heading">
                                <center>
                                    <h3 class="panel-title">PRUEBAS CELULARES PACIENTE</h3></center>
                            </div>
...
$conn = dbConnect();
  ...
  if (isset($_POST['paciente_cedula'])) {
    $sql2 = 'SELECT * FROM pc_paciente WHERE paciente_cedula = ?';
    $stmt = $conn->prepare($sql2);
    $results = $stmt->execute(array($_POST['paciente_cedula']));
    $row = $stmt->fetch();
    if (empty($row)) {
                 $sql = "INSERT INTO pc_paciente (fecha,grupo_sanguineo,factor_rh, du, cd,t_prueba,paciente_cedula,hemoterapista_cedula) VALUES (:fecha,:grupo_sanguineo,:factor_rh,:du,:cd,:t_prueba,:paciente_cedula,:hemoterapista_cedula)";
$q = $conn->prepare($sql);
...
$q->execute();
 ...
 $sql = "INSERT INTO pc_paciente_historia (fecha,grupo_sanguineo,factor_rh,du,cd,t_prueba,paciente_cedula,hemoterapista_cedula) VALUES (:fecha,:grupo_sanguineo,:factor_rh,:du,:cd,:t_prueba,:paciente_cedula,:hemoterapista_cedula)";
