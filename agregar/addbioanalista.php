...
?>
    ...
    <title>Agregar Bioanalista</title>
            ...
            <div class="container" style="margin-top:10px;">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-3 col-lg-offset-3 toppad">
                        <form class="form-horizontal" id="addbioanalista" method="post" action="../agregar/addbioanalista.php" role="form">
                            <div class="panel panel-info">
                                <div class="panel-heading">
                                    <center>
                                        <h3 class="panel-title">REGISTRAR BIOANALISTA</h3></center>
                                </div>
...
echo '<script language="javascript">swal("Bioanalista Almacenado Correctamente!",
"",
"success");</script>';
  ...
  echo '<script language="javascript"> swal("ERROR!", "El Bioanalista se encuentra registrado, o ha ocurrido un problema en la actualizacion.", "error");</script>';
