        ...
        <div class="container" style="margin-top:50px;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-3 col-lg-offset-3 toppad">
                    ...
                    <form accept-charset="UTF-8" role="form" method="POST" action="pp_donante.php">
                        <div class="panel panel-info">
                            <div class="panel-heading">
                                <center>
                                    <h3 class="panel-title">PRUEBAS PANTALLAS DEL DONANTE</h3></center>
                            </div>
...
$conn = dbConnect();
  ...
  if (isset($_POST['donante_cedula'])) {
    $sql2 = 'SELECT * FROM pantallas_donante WHERE donante_cedula = ?';
    ...
    if (empty($row)) {
                 ...
                 $sql = "INSERT INTO pantallas_donante (fecha,pantalla1,pantalla2,pantalla3,pantalla4,donante_cedula,hemoterapista_cedula) VALUES (:fecha,:pantalla1,:pantalla2,:pantalla3,:pantalla4,:donante_cedula,:hemoterapista_cedula)";
$q = $conn->prepare($sql);
...
$sql = "INSERT INTO pantallas_donante_historia (fecha,pantalla1,pantalla2,pantalla3,pantalla4,donante_cedula,hemoterapista_cedula) VALUES (:fecha,:pantalla1,:pantalla2,:pantalla3,:pantalla4,:donante_cedula,:hemoterapista_cedula)";
$q = $conn->prepare($sql);
$q->bindParam(':fecha', $_POST['fecha'], PDO::PARAM_STR);
$q->bindParam(':pantalla1', $_POST['pantalla1'], PDO::PARAM_STR);
$q->bindParam(':pantalla2', $_POST['pantalla2'], PDO::PARAM_STR);
...
$sql = "UPDATE pantallas_donante SET        
fecha='".$fecha."', 
pantalla1='".$pantalla1."', 
pantalla2='".$pantalla2."',
pantalla3='".$pantalla3."', 
