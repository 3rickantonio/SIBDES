...
<title>Editar Hemoterapista</title>
    ...
    <div class="container" style="margin-top:10px;">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-3 col-lg-offset-3 toppad">
                ...
                <form name="" method="POST" accion="edithemoterapista.php?cedula=<?php echo $row['cedula']; ?>">
                    <div class="panel panel-info">
                      ...
                      $conn = dbConnect();
                      $cedula=$_GET['cedula'];
                      $sql = "SELECT * FROM hemoterapista WHERE cedula=".$cedula;
