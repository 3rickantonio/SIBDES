        ...
        <body onKeyDown="javascript:Verificar()">
            <div class="container" style="margin-top:10px;">
                ...
                <div class="col-md-6">
                    ...
                    <br>
                    <form name="formulario" class="form-horizontal" role="form" accion="configuracion.php?username=<?php echo $row['username']; ?>" method="post">

                        <input type="hidden" value="<?php echo $row['id']; ?>" name="id">
                        <div class="form-group">
                            <label for="inputEmail1" class="col-lg-4 control-label">Nombre y Apellido:</label>
                            <div class="col-lg-8">
                                <input type="nombresyapellidos" class="form-control" id="nombresyapellidos" value="<?php if (isset($nombresyapellidos)) echo $nombresyapellidos; else echo $row['nombresyapellidos']; ?>" name="nombresyapellidos" placeholder="Nombre de usuario Actual">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputEmail1" class="col-lg-4 control-label">Username:</label>
                            <div class="col-lg-8">
                                <input type="text" class="form-control" value="<?php if (isset($username)) echo $username; else echo $row['username']; ?>" id="username" name="username" placeholder="Nombre de usuario">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputEmail1" class="col-lg-4 control-label">Fecha:</label>
                            <div class="col-lg-8">
                                <input type="text" class="form-control" value="<?php if (isset($fecha)) echo $fecha; else echo $row['fecha']; ?>" id="fecha" name="fecha" placeholder="Fecha">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <select id="valido" name="valido" required>
                                    <option value="<?php if (isset($valido)) echo $valido; else echo $row['valido']; ?>">
                                        <?php if (isset($valido)) echo $valido; else echo $row['valido']; ?>
                                    </option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <select id="sexo" name="sexo" required>
                                    <option value="<?php if (isset($sexo)) echo $sexo; else echo $row['sexo']; ?>">
                                        <?php if (isset($sexo)) echo $sexo; else echo $row['sexo']; ?>
                                    </option>
                                    <option value="">->Seleccione:</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control" value="<?php if (isset($telefono)) echo $telefono; else echo $row['telefono']; ?>" id="telefono" name="telefono" placeholder="Telefono">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input type="password" class="form-control" value="<?php if (isset($password)) echo $password; else echo $row['password']; ?>" name="password" placeholder="Nueva Contraseña">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-lg-offset-4 col-lg-8">
                                <button name="Guardar" type="submit" class="btn btn-success ">Guardar Cambios</button>
