...
<title>Consulta Bioanalista</title>
                ...
                <div class="panel panel-info">
                                ...
                                <table class="table table-user-information">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>Direccion:</td>
                                            <td width="30">
                                                <textarea name="direccion" disabled rows="3" cols="27"><?php echo $row['direccion']; ?></textarea>
                                            </td>
                                        </tr>
                    ...
                    <div class="panel-heading">
                        <center>
                            ...
                            <a class=" btn btn-danger" href="../edicion/editbioanalista.php?cedula=<?php echo $row['cedula'];?>">ACTUALIZAR DATOS</a>
